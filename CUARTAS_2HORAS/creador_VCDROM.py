...
path_list = ['cont4bits_tb_reducido/cont4bits_inst/clk',
             'cont4bits_tb_reducido/cont4bits_inst/reset_n',
             'cont4bits_tb_reducido/cont4bits_inst/enable',
             'cont4bits_tb_reducido/cont4bits_inst/Q',
             'cont4bits_tb_reducido/cont4bits_inst/TC']

extractor = WaveExtractor('cont4bits_tb_good2.vcd', 'cont4bits_tb_good2.json', path_list)
extractor.execute()